...
def test_two_level():
    ...
    # subsystem A
    reddenmat0 = pyqentangle.core.tncompute.bipartitepurestate_reduceddensitymatrix(tensor, 0)
    ...
    # subsystem B
    reddenmat1 = pyqentangle.core.tncompute.bipartitepurestate_reduceddensitymatrix(tensor, 1)
...
def test_fifteen_levels():
    ...
    reddenmat0 = pyqentangle.core.tncompute.bipartitepurestate_reduceddensitymatrix(tensor, 0)
    reddenmat1 = pyqentangle.core.tncompute.bipartitepurestate_reduceddensitymatrix(tensor, 0)
